...
namespace Password
{
    public partial class Register : Form
    {
        ...
        {
            File.Create("C:\\Users\\Lukas\\source\\repos\\Password\\Password\\bin\\Debug\\text.txt").Close();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            if (new FileInfo("C:\\Users\\Lukas\\source\\repos\\Password\\Password\\bin\\Debug\\text.txt").Length == 0)
            {
